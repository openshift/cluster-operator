	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.BoatswainV1alpha1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.BoatswainV1alpha1().Clusters(namespace).Watch(options)
			},
		},
		&boatswain_v1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&boatswain_v1alpha1.Cluster{}, defaultClusterInformer)
}
