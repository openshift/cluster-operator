...
func (in *CombinedCluster) DeepCopyInto(out *CombinedCluster) {
	*out = *in
	...
	if in.ClusterOperatorSpec != nil {
		in, out := &in.ClusterOperatorSpec, &out.ClusterOperatorSpec
		if *in == nil {
			*out = nil
		} else {
			*out = new(ClusterSpec)
	...
	if in.ClusterOperatorStatus != nil {
		in, out := &in.ClusterOperatorStatus, &out.ClusterOperatorStatus
		if *in == nil {
			*out = nil
		} else {
			*out = new(ClusterStatus)
	...
	if in.ClusterAPISpec != nil {
		in, out := &in.ClusterAPISpec, &out.ClusterAPISpec
		if *in == nil {
			*out = nil
		} else {
