...
// List lists all ClusterVersions in the indexer for a given namespace.
func (s clusterVersionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ClusterVersion, err error) {
...
// Get retrieves the ClusterVersion from the indexer for a given namespace and name.
func (s clusterVersionNamespaceLister) Get(name string) (*v1alpha1.ClusterVersion, error) {
