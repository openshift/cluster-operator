...
// checkBoatswainClientActions is the utility function for checking actions returned by
// the boatswain client
func checkBoatswainClientActions(actual []testing.Action, expected []catalogClientAction) error {
	if len(actual) != len(expected) {
