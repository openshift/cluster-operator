...
func NewList() runtime.Object {
	return &clusteroperator.NodeList{
		TypeMeta: metav1.TypeMeta{
			Kind: "NodeList",
		},
		Items: []clusteroperator.Node{},
	}
}
...
func toSelectableFields(node *clusteroperator.Node) fields.Set {
...
func NewStorage(opts etcd.Options) (nodes, nodesStatus rest.Storage) {
	...
	store := registry.Store{
		...
		DefaultQualifiedResource: clusteroperator.Resource("clusterservicenodes"),
