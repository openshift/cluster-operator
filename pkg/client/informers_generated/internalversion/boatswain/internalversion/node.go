	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.Boatswain().Nodes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.Boatswain().Nodes(namespace).Watch(options)
			},
		},
		&boatswain.Node{},
		resyncPeriod,
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&boatswain.Node{}, defaultNodeInformer)
}
