...
type ClusterVersionInterface interface {
	Create(*clusteroperator.ClusterVersion) (*clusteroperator.ClusterVersion, error)
	Update(*clusteroperator.ClusterVersion) (*clusteroperator.ClusterVersion, error)
	UpdateStatus(*clusteroperator.ClusterVersion) (*clusteroperator.ClusterVersion, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*clusteroperator.ClusterVersion, error)
	List(opts v1.ListOptions) (*clusteroperator.ClusterVersionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.ClusterVersion, err error)
...
func newClusterVersions(c *ClusteroperatorClient, namespace string) *clusterVersions {
...
func (c *clusterVersions) Get(name string, options v1.GetOptions) (result *clusteroperator.ClusterVersion, err error) {
	result = &clusteroperator.ClusterVersion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterVersions) List(opts v1.ListOptions) (result *clusteroperator.ClusterVersionList, err error) {
	result = &clusteroperator.ClusterVersionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterversions").
...
func (c *clusterVersions) Create(clusterVersion *clusteroperator.ClusterVersion) (result *clusteroperator.ClusterVersion, err error) {
	result = &clusteroperator.ClusterVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterversions").
...
func (c *clusterVersions) Update(clusterVersion *clusteroperator.ClusterVersion) (result *clusteroperator.ClusterVersion, err error) {
	result = &clusteroperator.ClusterVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterversions").
...
func (c *clusterVersions) UpdateStatus(clusterVersion *clusteroperator.ClusterVersion) (result *clusteroperator.ClusterVersion, err error) {
	result = &clusteroperator.ClusterVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterversions").
...
func (c *clusterVersions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.ClusterVersion, err error) {
	result = &clusteroperator.ClusterVersion{}
