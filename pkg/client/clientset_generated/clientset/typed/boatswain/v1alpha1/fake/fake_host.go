...
type FakeHosts struct {
	Fake *FakeBoatswainV1alpha1
}

var hostsResource = schema.GroupVersionResource{Group: "boatswain.openshift.io", Version: "v1alpha1", Resource: "hosts"}

var hostsKind = schema.GroupVersionKind{Group: "boatswain.openshift.io", Version: "v1alpha1", Kind: "Host"}
...
func (c *FakeHosts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Host, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(hostsResource, name, data, subresources...), &v1alpha1.Host{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Host), err
