...
type ClusterDeploymentInterface interface {
	Create(*clusteroperator.ClusterDeployment) (*clusteroperator.ClusterDeployment, error)
	Update(*clusteroperator.ClusterDeployment) (*clusteroperator.ClusterDeployment, error)
	UpdateStatus(*clusteroperator.ClusterDeployment) (*clusteroperator.ClusterDeployment, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*clusteroperator.ClusterDeployment, error)
	List(opts v1.ListOptions) (*clusteroperator.ClusterDeploymentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.ClusterDeployment, err error)
...
func newClusterDeployments(c *ClusteroperatorClient, namespace string) *clusterDeployments {
...
func (c *clusterDeployments) Get(name string, options v1.GetOptions) (result *clusteroperator.ClusterDeployment, err error) {
	result = &clusteroperator.ClusterDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterDeployments) List(opts v1.ListOptions) (result *clusteroperator.ClusterDeploymentList, err error) {
	result = &clusteroperator.ClusterDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterdeployments").
...
func (c *clusterDeployments) Create(clusterDeployment *clusteroperator.ClusterDeployment) (result *clusteroperator.ClusterDeployment, err error) {
	result = &clusteroperator.ClusterDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterdeployments").
...
func (c *clusterDeployments) Update(clusterDeployment *clusteroperator.ClusterDeployment) (result *clusteroperator.ClusterDeployment, err error) {
	result = &clusteroperator.ClusterDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterdeployments").
...
func (c *clusterDeployments) UpdateStatus(clusterDeployment *clusteroperator.ClusterDeployment) (result *clusteroperator.ClusterDeployment, err error) {
	result = &clusteroperator.ClusterDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterdeployments").
...
func (c *clusterDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.ClusterDeployment, err error) {
	result = &clusteroperator.ClusterDeployment{}
