...
func (_m *MockJobSyncStrategy) OnJobCompletion(owner v1.Object, succeeded bool) {
	_m.ctrl.Call(_m, "OnJobCompletion", owner, succeeded)
}

func (_mr *_MockJobSyncStrategyRecorder) OnJobCompletion(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "OnJobCompletion", arg0, arg1)
}
