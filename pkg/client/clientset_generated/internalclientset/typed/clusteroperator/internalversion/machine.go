...
type MachineInterface interface {
	Create(*clusteroperator.Machine) (*clusteroperator.Machine, error)
	Update(*clusteroperator.Machine) (*clusteroperator.Machine, error)
	UpdateStatus(*clusteroperator.Machine) (*clusteroperator.Machine, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*clusteroperator.Machine, error)
	List(opts v1.ListOptions) (*clusteroperator.MachineList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.Machine, err error)
	MachineExpansion
}
...
func newMachines(c *ClusteroperatorClient, namespace string) *machines {
	return &machines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *machines) Get(name string, options v1.GetOptions) (result *clusteroperator.Machine, err error) {
	result = &clusteroperator.Machine{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machines").
		Name(name).
...
func (c *machines) List(opts v1.ListOptions) (result *clusteroperator.MachineList, err error) {
	result = &clusteroperator.MachineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Create(machine *clusteroperator.Machine) (result *clusteroperator.Machine, err error) {
	result = &clusteroperator.Machine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Update(machine *clusteroperator.Machine) (result *clusteroperator.Machine, err error) {
	result = &clusteroperator.Machine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) UpdateStatus(machine *clusteroperator.Machine) (result *clusteroperator.Machine, err error) {
	result = &clusteroperator.Machine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *clusteroperator.Machine, err error) {
	result = &clusteroperator.Machine{}
