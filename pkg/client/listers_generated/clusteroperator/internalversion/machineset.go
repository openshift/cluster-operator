...
type MachineSetLister interface {
	...
	List(selector labels.Selector) (ret []*clusteroperator.MachineSet, err error)
...
// List lists all MachineSets in the indexer.
func (s *machineSetLister) List(selector labels.Selector) (ret []*clusteroperator.MachineSet, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*clusteroperator.MachineSet))
	})
	return ret, err
}
...
type MachineSetNamespaceLister interface {
	...
	Get(name string) (*clusteroperator.MachineSet, error)
...
// List lists all MachineSets in the indexer for a given namespace.
func (s machineSetNamespaceLister) List(selector labels.Selector) (ret []*clusteroperator.MachineSet, err error) {
...
// Get retrieves the MachineSet from the indexer for a given namespace and name.
func (s machineSetNamespaceLister) Get(name string) (*clusteroperator.MachineSet, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(clusteroperator.Resource("machineset"), name)
	}
	return obj.(*clusteroperator.MachineSet), nil
}
