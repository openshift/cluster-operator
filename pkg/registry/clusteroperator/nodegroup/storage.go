...
func NewList() runtime.Object {
	return &clusteroperator.NodeGroupList{
		TypeMeta: metav1.TypeMeta{
			Kind: "NodeGroupList",
		},
		Items: []clusteroperator.NodeGroup{},
	}
}

// CheckObject returns a non-nil error if obj is not a nodegroup object
func CheckObject(obj runtime.Object) error {
	_, ok := obj.(*clusteroperator.NodeGroup)
	if !ok {
...
func toSelectableFields(nodegroup *clusteroperator.NodeGroup) fields.Set {
...
func NewStorage(opts etcd.Options) (nodegroups, nodegroupsStatus rest.Storage) {
	...
	store := registry.Store{
		...
		DefaultQualifiedResource: clusteroperator.Resource("clusterservicenodegroups"),
