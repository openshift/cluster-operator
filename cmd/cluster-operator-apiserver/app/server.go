...
import (
	...
	"github.com/openshift/cluster-operator/pkg/apiserver"
	apiserveroptions "github.com/openshift/cluster-operator/pkg/apiserver/options"
)

// Run runs an API server with configuration according to opts
func Run(opts *options.ClusterOperatorServerRunOptions, stopCh <-chan struct{}) error {
	if stopCh == nil {
