...
func (_m *MockJobControl) ControlJobs(ownerKey string, owner v10.Object, buildNewJob bool, reprocessInterval *time.Duration, lastJobSuccess *time.Time, jobFactory JobFactory) (JobControlResult, *v11.Job, error) {
	ret := _m.ctrl.Call(_m, "ControlJobs", ownerKey, owner, buildNewJob, reprocessInterval, lastJobSuccess, jobFactory)
...
func (_mr *_MockJobControlRecorder) ControlJobs(arg0, arg1, arg2, arg3, arg4, arg5 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ControlJobs", arg0, arg1, arg2, arg3, arg4, arg5)
}
