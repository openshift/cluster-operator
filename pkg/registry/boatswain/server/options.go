...
// Options is the extension of a generic.RESTOptions struct, complete with boatswain
// specific things
type Options struct {
...
// This function produces a path that etcd storage understands, to the root of the resource
...
// This function should produce a path that etcd storage understands, to the resource
// by combining the namespace in the context with the given prefix
