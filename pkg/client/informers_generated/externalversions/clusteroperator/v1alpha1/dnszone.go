	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusteroperatorV1alpha1().DNSZones(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusteroperatorV1alpha1().DNSZones(namespace).Watch(options)
			},
		},
		&clusteroperator_v1alpha1.DNSZone{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dNSZoneInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusteroperator_v1alpha1.DNSZone{}, f.defaultInformer)
}
