...
// MockJobSyncReprocessStrategy is a mock of JobSyncReprocessStrategy interface
type MockJobSyncReprocessStrategy struct {
	ctrl     *gomock.Controller
	recorder *MockJobSyncReprocessStrategyMockRecorder
}

// MockJobSyncReprocessStrategyMockRecorder is the mock recorder for MockJobSyncReprocessStrategy
type MockJobSyncReprocessStrategyMockRecorder struct {
	mock *MockJobSyncReprocessStrategy
}

// NewMockJobSyncReprocessStrategy creates a new mock instance
func NewMockJobSyncReprocessStrategy(ctrl *gomock.Controller) *MockJobSyncReprocessStrategy {
	...
	mock.recorder = &MockJobSyncReprocessStrategyMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockJobSyncReprocessStrategy) EXPECT() *MockJobSyncReprocessStrategyMockRecorder {
	return m.recorder
}

// GetReprocessInterval mocks base method
func (m *MockJobSyncReprocessStrategy) GetReprocessInterval() time.Duration {
...
func (mr *MockJobSyncReprocessStrategyMockRecorder) GetReprocessInterval() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReprocessInterval", reflect.TypeOf((*MockJobSyncReprocessStrategy)(nil).GetReprocessInterval))
}

// GetLastJobSuccess mocks base method
func (m *MockJobSyncReprocessStrategy) GetLastJobSuccess(owner v11.Object) *time.Time {
...
func (mr *MockJobSyncReprocessStrategyMockRecorder) GetLastJobSuccess(owner interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLastJobSuccess", reflect.TypeOf((*MockJobSyncReprocessStrategy)(nil).GetLastJobSuccess), owner)
}
