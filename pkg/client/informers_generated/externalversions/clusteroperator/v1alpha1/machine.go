	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.ClusteroperatorV1alpha1().Machines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.ClusteroperatorV1alpha1().Machines(namespace).Watch(options)
			},
		},
		&clusteroperator_v1alpha1.Machine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusteroperator_v1alpha1.Machine{}, defaultMachineInformer)
}
