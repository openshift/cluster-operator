...
// Mock of JobSyncReprocessStrategy interface
type MockJobSyncReprocessStrategy struct {
	ctrl     *gomock.Controller
	recorder *_MockJobSyncReprocessStrategyRecorder
}

// Recorder for MockJobSyncReprocessStrategy (not exported)
type _MockJobSyncReprocessStrategyRecorder struct {
	mock *MockJobSyncReprocessStrategy
}

func NewMockJobSyncReprocessStrategy(ctrl *gomock.Controller) *MockJobSyncReprocessStrategy {
	mock := &MockJobSyncReprocessStrategy{ctrl: ctrl}
	mock.recorder = &_MockJobSyncReprocessStrategyRecorder{mock}
	return mock
}

func (_m *MockJobSyncReprocessStrategy) EXPECT() *_MockJobSyncReprocessStrategyRecorder {
	return _m.recorder
}

func (_m *MockJobSyncReprocessStrategy) GetReprocessInterval() time.Duration {
	ret := _m.ctrl.Call(_m, "GetReprocessInterval")
	ret0, _ := ret[0].(time.Duration)
	return ret0
}

func (_mr *_MockJobSyncReprocessStrategyRecorder) GetReprocessInterval() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetReprocessInterval")
}

func (_m *MockJobSyncReprocessStrategy) GetLastJobSuccess(owner v1.Object) *time.Time {
	ret := _m.ctrl.Call(_m, "GetLastJobSuccess", owner)
	ret0, _ := ret[0].(*time.Time)
	return ret0
}

func (_mr *_MockJobSyncReprocessStrategyRecorder) GetLastJobSuccess(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetLastJobSuccess", arg0)
}

// Mock of CheckBeforeUndo interface
type MockCheckBeforeUndo struct {
	ctrl     *gomock.Controller
	recorder *_MockCheckBeforeUndoRecorder
}

// Recorder for MockCheckBeforeUndo (not exported)
type _MockCheckBeforeUndoRecorder struct {
...
func NewMockCheckBeforeUndo(ctrl *gomock.Controller) *MockCheckBeforeUndo {
	...
	mock.recorder = &_MockCheckBeforeUndoRecorder{mock}
	return mock
}

func (_m *MockCheckBeforeUndo) EXPECT() *_MockCheckBeforeUndoRecorder {
	return _m.recorder
}

func (_m *MockCheckBeforeUndo) CanUndo(owner v1.Object) bool {
	ret := _m.ctrl.Call(_m, "CanUndo", owner)
	ret0, _ := ret[0].(bool)
	return ret0
}

func (_mr *_MockCheckBeforeUndoRecorder) CanUndo(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CanUndo", arg0)
}
