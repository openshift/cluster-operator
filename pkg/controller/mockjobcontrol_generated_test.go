...
func (_m *MockJobControl) ControlJobs(ownerKey string, owner v1.Object, buildNewJob bool, reprocessInterval *time.Duration, lastJobSuccess *time.Time, jobFactory JobFactory) (JobControlResult, *v10.Job, error) {
