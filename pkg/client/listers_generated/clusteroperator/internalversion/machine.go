...
type MachineLister interface {
	...
	List(selector labels.Selector) (ret []*clusteroperator.Machine, err error)
...
// List lists all Machines in the indexer.
func (s *machineLister) List(selector labels.Selector) (ret []*clusteroperator.Machine, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*clusteroperator.Machine))
	})
	return ret, err
}
...
type MachineNamespaceLister interface {
	...
	Get(name string) (*clusteroperator.Machine, error)
...
// List lists all Machines in the indexer for a given namespace.
func (s machineNamespaceLister) List(selector labels.Selector) (ret []*clusteroperator.Machine, err error) {
...
// Get retrieves the Machine from the indexer for a given namespace and name.
func (s machineNamespaceLister) Get(name string) (*clusteroperator.Machine, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(clusteroperator.Resource("machine"), name)
	}
	return obj.(*clusteroperator.Machine), nil
}
