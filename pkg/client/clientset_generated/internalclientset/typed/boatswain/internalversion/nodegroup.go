...
import (
	...
	scheme "github.com/staebler/boatswain/pkg/client/clientset_generated/internalclientset/scheme"
...
type NodeGroupInterface interface {
	Create(*boatswain.NodeGroup) (*boatswain.NodeGroup, error)
	Update(*boatswain.NodeGroup) (*boatswain.NodeGroup, error)
	UpdateStatus(*boatswain.NodeGroup) (*boatswain.NodeGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*boatswain.NodeGroup, error)
	List(opts v1.ListOptions) (*boatswain.NodeGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *boatswain.NodeGroup, err error)
	NodeGroupExpansion
}
...
func newNodeGroups(c *BoatswainClient, namespace string) *nodeGroups {
	return &nodeGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodeGroups) Get(name string, options v1.GetOptions) (result *boatswain.NodeGroup, err error) {
	result = &boatswain.NodeGroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodegroups").
		Name(name).
...
func (c *nodeGroups) List(opts v1.ListOptions) (result *boatswain.NodeGroupList, err error) {
	result = &boatswain.NodeGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodegroups").
...
func (c *nodeGroups) Create(nodeGroup *boatswain.NodeGroup) (result *boatswain.NodeGroup, err error) {
	result = &boatswain.NodeGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodegroups").
...
func (c *nodeGroups) Update(nodeGroup *boatswain.NodeGroup) (result *boatswain.NodeGroup, err error) {
	result = &boatswain.NodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodegroups").
...
func (c *nodeGroups) UpdateStatus(nodeGroup *boatswain.NodeGroup) (result *boatswain.NodeGroup, err error) {
	result = &boatswain.NodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodegroups").
...
func (c *nodeGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *boatswain.NodeGroup, err error) {
	result = &boatswain.NodeGroup{}
