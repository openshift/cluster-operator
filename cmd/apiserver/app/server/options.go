...
func NewServiceCatalogServerOptions() *BoatwsainServerOptions {
	opts := &BoatwsainServerOptions{
...
func (s *BoatwsainServerOptions) AddFlags(flags *pflag.FlagSet) {
	flags.StringVar(
		&s.StorageTypeString,
		"storage-type",
		"etcd",
