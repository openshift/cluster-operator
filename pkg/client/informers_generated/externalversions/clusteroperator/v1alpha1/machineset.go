	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.ClusteroperatorV1alpha1().MachineSets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.ClusteroperatorV1alpha1().MachineSets(namespace).Watch(options)
			},
		},
		&clusteroperator_v1alpha1.MachineSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusteroperator_v1alpha1.MachineSet{}, defaultMachineSetInformer)
}
