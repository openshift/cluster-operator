...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSMachineCondition) DeepCopyInto(out *AWSMachineCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSMachineCondition.
func (in *AWSMachineCondition) DeepCopy() *AWSMachineCondition {
	if in == nil {
		return nil
	}
	out := new(AWSMachineCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AWSMachineProviderStatus) DeepCopyInto(out *AWSMachineProviderStatus) {
	*out = *in
	...
	if in.Conditions != nil {
		...
		*out = make([]AWSMachineCondition, len(*in))
		for i := range *in {
