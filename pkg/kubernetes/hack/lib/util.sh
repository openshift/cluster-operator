...
# "pkg". E.g.:
# * default behavior: extensions/v1alpha1 -> apis/extensions/v1alpha1
...
kube::util::group-version-to-pkg-path() {
  ...
  case "${group_version}" in
    ...
    __internal)
      ...
      ;;
    federation/v1alpha1)
      echo "federation/apis/federation/v1alpha1"
      ;;
    meta/v1)
...
# default behavior: extensions/v1alpha1 -> extensions_v1alpha1
