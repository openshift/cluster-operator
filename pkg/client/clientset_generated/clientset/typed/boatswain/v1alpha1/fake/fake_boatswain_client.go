...
import (
	v1alpha1 "github.com/staebler/boatswain/pkg/client/clientset_generated/clientset/typed/boatswain/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeBoatswainV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeBoatswainV1alpha1) RESTClient() rest.Interface {
