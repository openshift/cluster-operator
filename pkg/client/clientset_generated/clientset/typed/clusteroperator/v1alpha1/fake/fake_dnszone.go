...
var dnszonesResource = schema.GroupVersionResource{Group: "clusteroperator.openshift.io", Version: "v1alpha1", Resource: "dnszones"}

var dnszonesKind = schema.GroupVersionKind{Group: "clusteroperator.openshift.io", Version: "v1alpha1", Kind: "DNSZone"}
...
func (c *FakeDNSZones) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DNSZone, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(dnszonesResource, c.ns, name, data, subresources...), &v1alpha1.DNSZone{})
